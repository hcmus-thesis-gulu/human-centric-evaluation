...
# embedding_folder = "ablation/dino/embeddings"
# context_folder = "ablation/dino/contexts/{distance}/pca-tsne/embedding-{embedding_dim}/intermediate-{intermediate_dim}"
